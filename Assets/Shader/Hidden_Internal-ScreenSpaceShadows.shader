...
SubProgram "d3d11 " {
Keywords { "SHADOWS_SPLIT_SPHERES" "UNITY_SINGLE_PASS_STEREO" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
...
SubProgram "d3d11 " {
Keywords { "SHADOWS_SINGLE_CASCADE" "UNITY_SINGLE_PASS_STEREO" }
"// shader disassembly not supported on DXBC"
}
SubProgram "d3d11 " {
...
SubProgram "d3d11 " {
Keywords { "SHADOWS_SINGLE_CASCADE" "SHADOWS_SPLIT_SPHERES" "UNITY_SINGLE_PASS_STEREO" }
"// shader disassembly not supported on DXBC"
}
}
Program "fp" {
