...
public class ParametricBoxFrameController : MonoBehaviour
{
  ...
  {
    Vector4 vector4 = new Vector4(this.width * 0.5f, this.height * 0.5f, this.length * 0.5f, this.edgeSize * 0.5f);
    ...
    materialPropertyBlock.SetColor(ParametricBoxFrameController._colorID, this.color);
    materialPropertyBlock.SetVector(ParametricBoxFrameController._sizeParamsID, vector4);
