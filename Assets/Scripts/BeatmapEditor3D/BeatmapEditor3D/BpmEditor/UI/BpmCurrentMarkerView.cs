...
// Type: BeatmapEditor3D.BpmEditor.UI.BpmCurrentMarkerView
...
{
  public class BpmCurrentMarkerView : BpmMarkerView
  {
    ...
    private void HandlePlayHeadUpdated() => this.SetPosition(this._bpmEditorState.sample);
  }
}
