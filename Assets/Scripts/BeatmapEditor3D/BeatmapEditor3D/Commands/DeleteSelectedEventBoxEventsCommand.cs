...
// Type: BeatmapEditor3D.Commands.DeleteSelectedEventBoxEventsCommand
...
{
  public class DeleteSelectedEventBoxEventsCommand : 
    ...
    IBeatmapEditorCommandMessageProvider
  {
    ...
    public (CommandMessageType, string) GetMessage() => (CommandMessageType.Normal, string.Format("Deleted {0} event box events", (object) this._cutCount));
  }
}
