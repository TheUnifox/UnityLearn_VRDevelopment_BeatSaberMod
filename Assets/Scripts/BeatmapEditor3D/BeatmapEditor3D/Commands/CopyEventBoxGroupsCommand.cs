...
// Type: BeatmapEditor3D.Commands.CopyEventBoxGroupsCommand
...
{
  public class CopyEventBoxGroupsCommand : 
    ...
    IBeatmapEditorCommandMessageProvider
  {
    ...
    public (CommandMessageType, string) GetMessage() => (CommandMessageType.Normal, string.Format("Copied {0} event box groups", (object) this._selectionState.eventBoxGroups?.Count));
  }
}
