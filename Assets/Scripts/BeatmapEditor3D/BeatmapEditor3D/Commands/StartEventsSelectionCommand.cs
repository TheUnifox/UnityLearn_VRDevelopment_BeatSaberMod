...
// Type: BeatmapEditor3D.Commands.StartEventsSelectionCommand
...
{
  public class StartEventsSelectionCommand : IBeatmapEditorCommand
  {
    [Inject]
    private readonly StartEventsSelectionSignal _signal;
    [Inject]
