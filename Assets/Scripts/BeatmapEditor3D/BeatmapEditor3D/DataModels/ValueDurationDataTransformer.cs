...
// Type: BeatmapEditor3D.DataModels.ValueDurationDataTransformer
...
{
  public class ValueDurationDataTransformer : IEventDataTransformer
  {
      ...
      BpmData bpmData)
    {
      ...
      for (int index = 0; index < events.Count; ++index)
      {
        ...
        float endTime = (object) basicEventEditorData2 != null ? basicEventEditorData2.beat : 3000f;
        ...
        basicEventEditorDataList.Add(BasicEventEditorData.CreateNewWithId(basicEventEditorData1.id, basicEventEditorData1.type, basicEventEditorData1.beat, basicEventEditorData1.value, basicEventEditorData1.floatValue, endTime, endValue, endFloatValue));
      }
