...
namespace BeatmapEditor3D.DataModels
{
  public class BeatmapDataModel : IBeatmapDataModel, IReadonlyBeatmapDataModel
  {
      ...
      bool clearDirty = false)
    {
      ...
      this.beatsPerMinute = nullable ?? this.beatsPerMinute;
      nullable = songTimeOffset;
      this.songTimeOffset = nullable ?? this.songTimeOffset;
      nullable = shuffle;
      this.shuffle = nullable ?? this.shuffle;
      nullable = shufflePeriod;
      this.shufflePeriod = nullable ?? this.shufflePeriod;
      nullable = previewStartTime;
      this.previewStartTime = nullable ?? this.previewStartTime;
      nullable = previewDuration;
      this.previewDuration = nullable ?? this.previewDuration;
