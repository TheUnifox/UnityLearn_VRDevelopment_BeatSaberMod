...
// Type: BeatmapEditor3D.ChangeHoveredArcControlPointCutDirectionAndLengthSignal
...
{
  public class ChangeHoveredArcControlPointCutDirectionAndLengthSignal
  {
    ...
    public ChangeHoveredArcControlPointCutDirectionAndLengthSignal(
