...
public class EditableBeatmapSelectionView : BeatmapSelectionView
{
  [Space]
  [SerializeField]
  ...
  [SerializeField]
  protected CanvasGroup _levelBarCanvasGroup;
  ...
  public bool interactable
  {
    ...
    set
    {
      ...
      this._levelBarCanvasGroup.alpha = this._interactable ? 1f : 0.25f;
    }
  }
  ...
  public override void SetBeatmap(PreviewDifficultyBeatmap beatmapLevel)
  {
    base.SetBeatmap(beatmapLevel);
    this._clearButton.gameObject.SetActive(this.showClearButton && beatmapLevel != (PreviewDifficultyBeatmap) null);
  }
}
