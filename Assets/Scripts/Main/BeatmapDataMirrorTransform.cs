...
public abstract class BeatmapDataMirrorTransform
{
    ...
    BeatmapDataItem ProcessData(BeatmapDataItem beatmapDataItem)
    {
      switch (beatmapDataItem)
      {
        case BeatmapObjectData beatmapObjectData:
          beatmapObjectData.Mirror(numberOfLines);
          return beatmapDataItem;
        case SpawnRotationBeatmapEventData beatmapEventData:
          beatmapEventData.Mirror();
          return (BeatmapDataItem) beatmapEventData;
        default:
          return beatmapDataItem;
      }
    }
