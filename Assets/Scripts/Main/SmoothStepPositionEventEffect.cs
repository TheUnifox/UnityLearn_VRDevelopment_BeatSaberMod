...
public class SmoothStepPositionEventEffect : MonoBehaviour
{
  [SerializeField]
  ...
  public virtual void Awake()
  {
    ...
    this._positionTween = new Vector3Tween(this._startPos, this._startPos, new System.Action<Vector3>(this.SetPosition), 0.0f, EaseType.InOutCubic);
  }
  ...
  public virtual Vector3 GetPositionForValue(int value)
  {
    ...
    return this._startPos + this._movementVector * (this._stepSize * (float) (value - 4));
  }

  public virtual void SetPosition(Vector3 position) => this.transform.localPosition = position;
}
