...
label_24:
    ...
    public virtual bool HasHigherPriority(T higher, T lower)
    {
      if ((double) higher.Priority < (double) lower.Priority)
        return true;
      return (double) higher.Priority == (double) lower.Priority && higher.InsertionIndex < lower.InsertionIndex;
    }
