...
public class PreviewBeatmapLevelPackSO : 
  ...
  IAnnotatedBeatmapLevelCollection
{
  ...
  [Space]
  [SerializeField]
  protected PreviewBeatmapLevelCollectionSO _previewBeatmapLevelCollection;
  ...
  public IBeatmapLevelCollection beatmapLevelCollection => (IBeatmapLevelCollection) this._previewBeatmapLevelCollection;
}
